...
//    }
    ...
    public void testAverage() {
        ...
        assertEquals(0.4, table.average());

        table.setValue(2, 2, -3);

        assertEquals(0.2, table.average());
    }

    //6
    @Test
    public void testCylinderWithValidDimensions() throws IncorrectHeightException, IncorrectRadiusException {
    ...
    public void testCylinderWithInvalidRadius() {
        Exception exception = assertThrows(IncorrectRadiusException.class, () -> {
            new Cylinder(0, 5.0);
        });
    ...
    public void testCylinderWithInvalidHeight() {
        Exception exception = assertThrows(IncorrectHeightException.class, () -> {
            new Cylinder(3.0, 0);
        });
